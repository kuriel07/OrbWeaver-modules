 ...
 */
extern int fmustach_json_c(const char *str, struct json_object *root, FILE *file);
 ...
 * a other negative value in case of error.
 */
extern int fdmustach_json_c(const char *str, struct json_object *root, int fd);
 ...
 * a other negative value in case of error.
 */
extern int mustach_json_c(const char *str, struct json_object *root, char **result, size_t *size);
...
extern int umustach_json_c(const char *str, struct json_object *root, mustach_json_c_write_cb writecb, void *closure);
